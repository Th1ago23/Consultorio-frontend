      ...
      <div className="container flex items-center justify-between h-16 mx-auto">
        ...
        <ul className="items-center hidden space-x-6 lg:flex animate-fade-in">
          ...
          >
            ...
            {isDropdownOpen && (
              <div className="absolute left-0 z-10 w-40 mt-2 transition-all duration-200 origin-top transform scale-y-100 bg-white border border-gray-200 rounded-md shadow-lg opacity-100 dark:bg-gray-800 dark:border-gray-700">
                <a
