      ...
      <section className="dark:bg-gray-100 dark:text-gray-800">
        <div className="container flex flex-col-reverse justify-center px-6 mx-auto sm:py-12 lg:py-24 lg:flex-row lg:justify-between">
          ...
          <div className="flex flex-col justify-center p-6 text-center rounded-sm lg:max-w-xl xl:max-w-2xl lg:text-left">
            <h1 className="text-4xl font-extrabold leading-tight text-[#972121] sm:text-5xl">
            ...
            <div className="flex flex-col space-y-4 sm:items-center sm:justify-center sm:flex-row sm:space-y-0 sm:space-x-4 lg:justify-start">
              <a
                href="/login"
                className="px-8 py-3 text-lg font-semibold text-white bg-[#800000] rounded-full shadow-md hover:bg-[#9E2A2B]"
              >
                Agendar Consulta
              </a>
              <a
                href="#"
                className="px-8 py-3 text-lg font-semibold text-[#800000] border border-[#800000] rounded-full hover:bg-[#9E2A2B] hover:text-white"
              >
                Fale Conosco
              </a>
            </div>
        ...
        <div className="container px-6 mx-auto text-center">
          ...
          <div className="grid grid-cols-1 gap-8 md:grid-cols-2 lg:grid-cols-3">
            ...
            <div className="p-6 text-left transition-shadow bg-white shadow-lg rounded-2xl hover:shadow-xl">
              <div className="flex items-center mb-4 text-[#800000]">
